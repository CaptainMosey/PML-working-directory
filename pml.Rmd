...
train[,8:ncol(train)-2]<-predict(imputeObj,train[,8:ncol(train)-1])
```
Covariate Creation
===================
...
Finally, the test data set was processed idenitcally to the training set and run through the random forest algorithm. 
